...
public class frmAlumnos extends JFrame {
    ...
    private void EdadXCurp(){
        ...
        alumno NVO = new alumno(nombre, apaterno, amaterno, CURP, correo, telefono,discapacidad,sexo);
        String fecha = NVO.getCURP();
        JOptionPane.showMessageDialog(null,"Edad: " + NVO.EdadXCurp(fecha));
    }
